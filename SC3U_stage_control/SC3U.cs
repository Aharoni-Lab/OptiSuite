...
//  Chat notes that you should declare a namespace
/*  acts as a container that helps in organizing code elements and preventing naming conflicts
 *  if two classes have the same name but reside in different namespaces, they can coexist without any issues.
 */
namespace SC3Us
{

    public class SC3U : UserControl //: means inherits from UserControl
    {
        ...
        private Label label7; // Displays the target position
        ...
        private Label label1; // Displays the current position
        ...
        private Label label4; // Displays the max speed
        ...
        private Label label6; // Displays the stage type

        private ComboBox CboUnit;

        private Label label8; // Displays the running unit

        private ComboBox CboMotorAngle;

        private Label label9; // Displays the motor angle

        private ComboBox CboSubsection;

        private Label label10; // Displays the subdivision

        private ComboBox CboPitch;

        private Label label11; // Displays the screw lead

        private ComboBox CboTranRatio;

        private Label label12; // Displays the transmission ratio

        private ComboBox CboTravel;

        private Label label13; // Displays the travel range

        private ComboBox CboNegaTravel;

        private Label label14; // Displays the negative travel limit

        private ComboBox CboPosiTravel;

        private Label label15; // Displays the positive travel limit
        ...
        private Label label2; // Displays the communication port/separator line?
        ...
        //if this is true, then there will be a busy, try later when you try to execute multiple commands
        ...
        public SC3U()   //class consturctor, used to set initial values for fields when an object of this class is created
        {
            InitializeComponent();
            RadAxis[0] = RadXAxis;
            RadAxis[1] = RadYAxis;
            ...
            base.Width = 563;
            ShrLanguage = 0;    //set it to 0 for Chinese to see if this function works
            ChangeLanguage();
        }

        ~SC3U() //destructor - used to clean up resources when an object of this class is destroyed
        {
            BlnStopCommand = true;
        ...
        //move the stage back to the axis's 0
        ...
        //runs the stage to the designated position (in mm or degree) on the current axis
        ...
        //I assume this is a delay? it's coded like it is the other way around (while true do tasks vs while true, wait)
        private void Delay(long milliSecond = 500L, bool IsCheck = true)
        {
            int tickCount = Environment.TickCount; //TickCount is the number of milliseconds that have elapsed since the system started.
            BlnReadCom = false;
            if (IsCheck)
            {
        ...
        private void ChangeLanguage()
        {
            ...
            {
                //in: change language
                //messing with the names of these doesn't seem to change them on the gui
        ...
        //pretty sure this creates the entire GUI for the form
        private void InitializeComponent()
        {
            ...
            this.label1.Size = new System.Drawing.Size(92, 27); //changed from 92,27 to 100,100
